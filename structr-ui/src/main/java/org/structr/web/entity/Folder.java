...
public class Folder extends AbstractFile implements CMISInfo, CMISFolderInfo {
	...
	public static final View publicView = new View(Folder.class, PropertyView.Public, id, type, name, owner, isFolder, folders, files, parentId, visibleToPublicUsers, visibleToAuthenticatedUsers);
